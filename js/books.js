...
function bookCover(book) {
  const src = book.custom_thumbnail || book.thumbnail;
  if (src) {
    return `<img class="book-cover" src="${escHtml(src)}" alt="Cover" loading="lazy" onerror="this.replaceWith(coverPlaceholder())">`;
  }
